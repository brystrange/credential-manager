...
import { PLATFORMS, getPlatformLogoUrl, getCategories } from "../data/platformData";
    ...
    if (disabled && value) {
        return (
            <div className="platform-picker-display">
                {selectedPlatform && !imgErrors.has(selectedPlatform.id) ? (
                    <img
                        src={getPlatformLogoUrl(selectedPlatform.domain)}
            ...
            {isOpen && (
                <div className="platform-picker-dropdown">
                    ...
                    <div className="platform-picker-grid">
                        {categories.map((cat) => {
                            const platforms = platformsByCategory.get(cat) || [];
                                    ...
                                    <div className="platform-tiles">
                                        {platforms.map((p) => (
                                            ...
                                            >
                                                {!imgErrors.has(p.id) ? (
                                                    <img
                                                        src={getPlatformLogoUrl(p.domain)}
                                                        alt={p.name}
